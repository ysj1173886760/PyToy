...
_PARAMETERPUSHREQ = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='node_graidents', full_name='ParameterPushReq.node_graidents', index=0,
...
_PARAMETERPULLRESP = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='node_graidents', full_name='ParameterPullResp.node_graidents', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PARAMETERPUSHREQ.fields_by_name['node_graidents'].message_type = common__pb2._NODEGRAIDENTS
_PARAMETERPULLREQ.fields_by_name['nodes'].message_type = common__pb2._NODE
_PARAMETERPULLRESP.fields_by_name['node_graidents'].message_type = common__pb2._NODEGRAIDENTS
